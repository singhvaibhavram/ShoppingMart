    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content modal-my">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" name="pageno" value="items">
          </div>
          <div class="form-group">
...
<br/>
  ...
  $sql = ("SELECT title FROM sub_category WHERE sub_id='$c_id'");
  ...
  $title = $row['title'];
    ...
    $sql = ("SELECT * FROM t_shirts WHERE sub_id='$c_id'");
    ...
    $result = mysqli_query($conn,$sql);
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            echo "<div align='center' class='col-sm-3 items'>
                    <a href=\"item_desc.php?item_id={$row['item_id']}\" class=''>
                    <img class='img-responsive img-itm' src=\"$image$img_name\" alt=''>
                    <h5 class='h5n'><b>$name</b></h5>
                    <h5 class='h5p'>Rs. $price</h5>
                    <p class='itm'>Size - $size</p>
                    <p class='itm'>Brand - $brand</p>
                    </a>
                    </div>";
        }
        echo "</div>";
